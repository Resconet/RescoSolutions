...
(function () {
	...
	if (typeof MobileCRM === "undefined") {
		...
		MobileCRM.UI.MediaTab.prototype._onCommand = function (commandIndex, errorCallback) {
			...
			mediaTab.invokeMethodAsync("View.ExecuteAction", [commandIndex], undefined, errorCallback);
			mediaTab.release();
		};
		MobileCRM.UI.MediaTab.prototype.setEditable = function (editable, errorCallback) {
			...
			/// <param name="errorCallback" type="function(errorMsg)">The errorCallback which is called in case of error.</param>
			var mediaTab = MobileCRM.bridge.exposeObjectAsync("EntityForm.Controllers.get_Item", [this.index]);
			mediaTab.invokeMethodAsync("set_IsEditable", [editable], undefined, errorCallback);
			mediaTab.release();
		};
		MobileCRM.UI.MediaTab.prototype.setCommandsMask = function (commandMask, errorCallback) {
			...
			/// <param name="errorCallback" type="function(errorMsg)">The errorCallback which is called in case of error.</param>
			var mediaTab = MobileCRM.bridge.exposeObjectAsync("EntityForm.Controllers.get_Item", [this.index]);
			mediaTab.invokeMethodAsync("set_CommandsMask", [commandMask], undefined, errorCallback);
			mediaTab.release();
		};
		MobileCRM.AboutInfo.requestObject = function (callback, errorCallback, scope) {
			...
			MobileCRM.bridge.invokeStaticMethodAsync(
				"MobileCrm",
				"MobileCrm.Controllers.AboutForm",
				"LoadAboutInfo",
				[],
				function (res) {
					var aboutInfo = new MobileCRM.AboutInfo();
					for (var property in res) {
						if (Object.prototype.hasOwnProperty.call(aboutInfo, property)) {
		...
		MobileCRM.UI.MediaTab.prototype.setNoteSubject = function (subject, errorCallback, scope) {
			...
			/// <param name="scope" type="Object">The scope for callbacks.</param>
			var mediaTab = MobileCRM.bridge.exposeObjectAsync("EntityForm.Controllers.get_Item", [this.index]);
			mediaTab.invokeMethodAsync("set_NoteSubject", [subject], undefined, errorCallback, scope);
			mediaTab.release();
		};
		// MobileCRM.Bridge
		...
		MobileCRM.Bridge.prototype.invokeStaticMethodAsync = function (assembly, typeName, method, paramsList, callback, errorCallback, scope) {
			...
			/// <param name="errorCallback" type="function(errorMsg)">The errorCallback which is called asynchronously in case of error.</param>
			/// <param name="scope" type="Object">The scope for callbacks.</param>
			return MobileCRM.bridge.command(
				"invokeMethod",
				(assembly ? assembly + ":" : "") + typeName + "." + method + JSON.stringify(paramsList),
				callback,
				errorCallback,
				scope
			);
		...
		MobileCRM.Bridge.prototype.invokeCommandPromise = function (command, args) {
			return new Promise(function (resolve, reject) {
				MobileCRM.bridge.command(command, args, resolve, function (err) {
		...
		MobileCRM.Configuration.requestObject = function (callback, errorCallback, scope) {
			...
			/// <param name="errorCallback" type="function(errorMsg)">The errorCallback which is called in case of error.</param>
			/// <param name="scope" type="Object">The scope for callbacks.</param>
			MobileCRM.bridge.requestObject(
				"Configuration",
				function (obj) {
		...
		MobileCRM.CultureInfo.initializeAsync = function () {
			...
			return new Promise(function (resolve, reject) {
				MobileCRM.CultureInfo.initialize(resolve, function (err) {
					reject(new Error(err));
				});
			});
		};
				...
				switch (c) {
					...
					case "z":
						if (format.charAt(++i) === "z") {
							var oz = -date.getTimezoneOffset();
							if (format.charAt(++i) === "z") {
								res += (oz < 0 ? "-" : "") + zeroPad(Math.abs(oz / 60), 2, false) + ":" + zeroPad(oz % 60, 2, false);
								i++;
							} else {
								res += (oz < 0 ? "-" : "") + zeroPad(Math.abs(oz / 60), 2, false);
							}
						} else {
		...
		MobileCRM.Localization.initializeAsync = function (regularExpression) {
			...
			return new Promise(function (resolve, reject) {
				MobileCRM.Localization.initializeEx(regularExpression, resolve, function (err) {
					reject(new Error(err));
				});
			});
		};
		...
		MobileCRM.Localization.getComponentLabel = function (entityName, componentType, viewName) {
			...
			return (
				MobileCRM.Localization.stringTable[entityName + "." + componentType + "." + viewName] ||
				MobileCRM.Localization.stringTable[componentType + "." + viewName] ||
				viewName
			);
		};
		...
		MobileCRM.ManyToManyReference.addRecord = function (entityName, ref1, ref2, create, success, failed, scope) {
			...
			/// <param name="scope" type="">A scope for calling the callbacks; set &quot;null&quot; to call the callbacks in global scope.</param>
			MobileCRM.bridge.command(
				"addManyToManyReference",
				JSON.stringify({ entityName: entityName, ref1: ref1, ref2: ref2, create: create }),
				success,
				failed,
				scope
			);
		...
		MobileCRM.DynamicEntity.saveDocumentBody = function (entityId, entityName, relationship, filePath, mimeType, success, failed, scope) {
			...
			MobileCRM.bridge.command(
				"documentBodysave",
				JSON.stringify({ entity: entityName, id: entityId, relationship: relationship, filePath: filePath, mimeType: mimeType }),
				success,
				failed,
				scope
			);
		...
		MobileCRM.Metadata._childParentMap = {
		...
		MobileCRM.FetchXml.Fetch.prototype.executeAsync = function (output, online) {
			...
			return new Promise(function (resolve, reject) {
				...
				_this.execute(format, resolve, function (err) {
					reject(new Error(err));
				});
			});
		};
		...
		MobileCRM.Platform._executeAction = function (action, data, success, failed, scope) {
		...
		MobileCRM.Platform.makeCall = function (telephone, errorCallback, scope) {
			...
			MobileCRM.Platform._executeAction(0, tel, undefined, errorCallback, scope);
		};
		MobileCRM.Platform.sendSMS = function (phoneNumber, text, errorCallback, scope) {
			...
			MobileCRM.Platform._executeAction(2, tel, undefined, errorCallback, scope);
		};
		MobileCRM.Platform.email = function (address, subject, body, errorCallback, scope) {
			...
			MobileCRM.Platform._executeAction(1, emailContent, null, errorCallback, scope);
		};
		...
		MobileCRM.Platform.openDocument = function (path, mimeType, args, errorCallback, scope) {
			...
			MobileCRM.Platform._executeAction(5, c, null, errorCallback, scope);
		};
		...
		MobileCRM.Platform.openUrl = function (url) {
			...
			MobileCRM.Platform._executeAction(3, param, null, null);
		};
		...
		MobileCRM.Platform.navigateTo = function (latitude, longitude, failed, scope) {
			...
			MobileCRM.Platform._executeAction(4, params, undefined, failed, scope);
		};
		...
		MobileCRM.Platform.preventBackButton = function (handler, scope) {
			...
			MobileCRM.bridge.command(
				...
				handler ? MobileCRM.bridge._createCmdObject(handler, null, scope) : null,
				handler,
				null,
				scope
			);
		...
		MobileCRM.Application.synchronize = function (backgroundOnly, ifNotSyncedBefore) {
			...
			MobileCRM.bridge.invokeStaticMethodAsync("MobileCrm", "MobileCrm.Controllers.HomeForm", "Instance.Synchronize", [
				backgroundOnly,
				ifNotSyncedBefore,
			]);
		};
		...
		MobileCRM.Application.writeFileWithEncoding = function (path, text, encoding, append, success, failed, scope) {
			...
			if (MobileCRM.bridge.platform === "WebClient") {
				...
				var reader = MobileCRM.bridge.exposeObjectAsync("MobileCrm.Data:MobileCrm.Configuration.Instance.OpenStorageWriterEnc", [
					path,
					append,
					encoding || null,
				]); // MR: same comment as in function above
				reader.invokeMethodAsync("Write", [text], success, failed, scope);
				reader.invokeMethodAsync("Dispose", [], undefined, failed, scope);
				reader.release();
			}
		...
		MobileCRM.Application.readFileAsBase64 = function (path, success, failed, scope) {
			...
			MobileCRM.bridge.invokeStaticMethodAsync(
				"MobileCrm.Data",
				"MobileCrm.Configuration",
				"Instance.ReadStorageFileAsBase64",
				[path],
				success,
				failed,
				scope
		...
		MobileCRM.Application.writeFileFromBase64 = function (path, base64, success, failed, scope) {
			...
			MobileCRM.bridge.invokeStaticMethodAsync(
				"MobileCrm.Data",
				"MobileCrm.Configuration",
				"Instance.WriteStorageFileFromBase64",
				[path, base64],
				success,
				failed,
				scope
		...
		MobileCRM.UI.RoutePlan._handlers = {
			onSave: [],
			onPostSave: [],
			onRouteReloaded: [],
			onItemAdded: [],
		...
		MobileCRM.UI._DetailView.prototype.addItemToGrid = function (gridName, item, column, row, colSpan, rowSpan) {
			...
			if (grid && grid.items) {
				// simple validation if item exists and is type of grid (only grid has items) | check for instance of is not working.
				var data = {};
		...
		MobileCRM.UI._DetailView.prototype.registerClickHandler = function (item, callback, scope) {
			...
			if (itemIndex > -1) {
				// execute command to register click handler for existing item only.
				var data = {
		...
		MobileCRM.UI.ProcessController.prototype.changeProcess = function (processRef, errorCallback, scope) {
			...
			controller.invokeMethodAsync("ChangeProcessTo", [processRef], undefined, errorCallback, scope);
			controller.release();
		};
		MobileCRM.UI.ProcessController.prototype.moveToPreviousStage = function (errorCallback, scope) {
			...
			/// <param name="scope" type="Object">The scope for callback.</param>
			var controller = MobileCRM.bridge.exposeObjectAsync("EntityForm.GetController", [this.view.name]);
			controller.invokeMethodAsync("MoveToPreviousStage", [], undefined, errorCallback, scope);
			controller.release();
		};
		MobileCRM.UI.ProcessController.prototype.moveToNextStage = function (errorCallback, scope) {
			...
			/// <param name="scope" type="Object">The scope for callback.</param>
			var controller = MobileCRM.bridge.exposeObjectAsync("EntityForm.GetController", [this.view.name]);
			controller.invokeMethodAsync("MoveToNextStage", [], undefined, errorCallback, scope);
			controller.release();
		};
		...
		MobileCRM.UI.HomeForm.openHomeItemAsync = function (name, errorCallback, scope) {
			...
			MobileCRM.bridge.invokeStaticMethodAsync(
				"MobileCrm",
				"MobileCrm.Controllers.HomeForm",
				"Instance.ShowHomeItemByName",
				[name],
				null,
				errorCallback,
				scope
		...
		MobileCRM.UI.HomeForm.updateHomeItemAsync = function (items, title, subTitle, badge, errorCallback, scope) {
			...
			MobileCRM.bridge.invokeStaticMethodAsync(
				"MobileCrm",
				"MobileCrm.Controllers.HomeForm",
				"Instance.UpdateHomeItem",
				[path, title, subTitle, badge],
				null,
				errorCallback,
				scope
			);
		...
		MobileCRM.UI.HomeForm.closeHomeItemAsync = function (name, errorCallback, scope) {
			...
			/// <param name="errorCallback" type="function(errorMsg)">The errorCallback which is called in case of error.</param>
			/// <param name="scope" type="Object">The scope for callbacks.</param>
			MobileCRM.UI.HomeForm.requestObject(
				function (homeForm) {
					for (var i in homeForm.items) {
						var item = homeForm.items[i];
						if (item.name == name || item.uniqueName === name) {
							var itemObj = MobileCRM.bridge.exposeObjectAsync("HomeForm.Items.get_Item", [i]);
							itemObj.invokeMethodAsync("CloseForm", [], null, errorCallback, scope);
							itemObj.release();
							return;
						}
					}
		...
		MobileCRM.UI.HomeForm.closeForms = function (callback, errorCallback, scope) {
			...
			/// <param name="errorCallback" type="function(errorMsg)">The errorCallback which is called in case of error.</param>
			/// <param name="scope" type="Object">The scope for callbacks.</param>
			MobileCRM.bridge.invokeMethodAsync(
				"HomeForm",
				"TryCloseForms",
				[false],
				function () {
		...
		MobileCRM.MobileReport.runReportAsync = function (fetch, reportXML, reportFormat, isExportOnly, isOnline, outputFile) {
			...
			return new Promise(function (resolve, reject) {
				MobileCRM.MobileReport.runReport(fetch, reportXML, reportFormat, isExportOnly, isOnline, outputFile, resolve, function (err) {
					reject(new Error(err));
				});
			});
		};
		...
		MobileCRM.Questionnaire.getQuestionName = function (name, repeatIndex) {
			...
			return repeatIndex ? name + "#" + MobileCRM.Questionnaire._padTo3digits(repeatIndex) : name;
		};
		...
		MobileCRM.UI.EntityList.setEntityProperty = function (rowIndex, propertyName, editValue, saveImmediately, errorCallback, scope) {
			...
			MobileCRM.bridge.invokeMethodAsync(
				"EntityList",
				"FinishListEditByName",
				[rowIndex, propertyName, editValue, saveImmediately ? MobileCRM.UI.EntityListCellAction.DirectEdit : 0],
				null,
				errorCallback,
				scope
			);
		...
		MobileCRM.UI.EntityList.clickCell = function (rowIndex, cellIndex, errorCallback, scope) {
			...
			MobileCRM.bridge.invokeMethodAsync(
				"EntityList",
				"StartListEdit",
				[rowIndex, cellIndex, MobileCRM.UI.EntityListCellAction.Clickable, null],
				null,
				errorCallback,
				scope
			);
		...
		MobileCRM.UI.QuestionnaireForm._pendingSaveId = 0;
		MobileCRM.UI.QuestionnaireForm.prototype.suspendSave = function () {
			...
			/// <returns type="Object">A request object with single method &quot;resumeSave&quot; which has to be called with the validation result (either error message string or &quot;null&quot; in case of success). To cancel the validation without any message, pass "#NoMessage#" text to this method.</returns>
			var cmdId = "QuestionnaireFormPendingValidation" + ++MobileCRM.UI.QuestionnaireForm._pendingSaveId;
			var _this = this;
		...
		MobileCRM.UI.QuestionnaireForm.trySetImageAnswer = function (imageQuestionName, base64Data, mimeType, errorCallback, scope) {
			...
			MobileCRM.bridge.invokeMethodAsync(
				"QuestionnaireForm",
				"TrySetImageAnswer",
				[imageQuestionName, base64Data, mimeType],
				null,
				errorCallback,
				scope
			);
		...
		MobileCRM.UI.QuestionnaireForm.overridePicklistOptions = function (questionName, allowNull, options, errorCallback, scope) {
			...
			MobileCRM.bridge.invokeMethodAsync(
				"QuestionnaireForm",
				"OverridePicklistOptions",
				[questionName, allowNull ? true : false, optionsSt],
				null,
				errorCallback,
				scope
			);
		...
		MobileCRM.UI.EntityForm._handlers = {
			onChange: [],
			onSave: [],
			onPostSave: [],
			onDetailCollectionChange: [],
		...
		MobileCRM.UI.EntityForm.prototype.selectTab = function (tabName, errorCallback, scope) {
			...
			/// <param name="errorCallback" type="function(errorMsg)">The errorCallback which is called asynchronously in case of error.</param>
			/// <param name="scope" type="Object">The scope for callback.</param>
			MobileCRM.UI.EntityForm.selectTabEx(tabName, undefined, errorCallback, scope);
		};
		...
		MobileCRM.UI.EntityForm.prototype.selectView = function (tabName, viewName) {
			...
			var controllers = this.controllers;
			var i, view, list, viewFilter;
			for (i = 0; i < controllers.length; i++) {
				var controller = controllers[i];
				view = controller.view;
				if (view && view.name == tabName) {
					list = MobileCRM.bridge.exposeObjectAsync("EntityForm.Controllers.get_Item", [i]);
					// Expose the filter item for key 'View'
					viewFilter = list.exposeObjectAsync("List.FilterGroup.get_Item", ["View"]);
			...
			for (i = 0; i < assocViews.length; i++) {
				var assocView = assocViews[i];
				view = assocView.listView;
				if (view && view.name == tabName) {
					list = MobileCRM.bridge.exposeObjectAsync("EntityForm.AssociatedViews.get_Item", [i]);
					// Expose the filter item for key 'View'
					viewFilter = list.exposeObjectAsync("FilterGroup.get_Item", ["View"]);
					// Select desired view in filter item
					viewFilter.invokeMethodAsync("SetSelection", [viewName, false]);
					// release exposed filter item
					viewFilter.release();
		...
		MobileCRM.UI.EntityForm.prototype.setTabVisibility = function (tabName, visible) {
			...
			for (i = 0; i < controllers.length; i++) {
				...
				if (view && view.name == tabName) {
					...
					if (Object.prototype.hasOwnProperty.call(controller, "isLoaded") && controller.isLoaded === false) {
			...
			var detailViews = this.detailViews;
			for (i = 0; i < detailViews.length; i++) {
		...
		MobileCRM.UI.EntityForm._pendingSaveId = 0;
		MobileCRM.UI.EntityForm.prototype.suspendSave = function () {
			/// <summary>Suspends current &quot;onSave&quot; validation and allows performing another asynchronous tasks to determine the validation result</summary>
			/// <returns type="Object">A request object with single method &quot;resumeSave&quot; which has to be called with the validation result (either error message string or &quot;null&quot; in case of success). To cancel the validation without any message, pass "#NoMessage#" text to this method.</returns>
			var cmdId = "EntityFormPendingValidation" + ++MobileCRM.UI.EntityForm._pendingSaveId;
			var entityForm = this;
		...
		MobileCRM.UI.EntityForm.DetailCollection.getAllAsync = function () {
			...
			return new Promise(function (resolve, reject) {
				MobileCRM.UI.EntityForm.DetailCollection.getAll(resolve, function (err) {
					reject(new Error(err));
				});
			});
		};
		MobileCRM.UI.EntityForm.DetailCollection.get = function (index, callback, errorCallback, scope) {
			...
			MobileCRM.bridge.invokeMethodAsync(
				"EntityForm",
				"Entity.DetailCollection.get_Item",
				[index],
				function (entity) {
		...
		MobileCRM.UI.EntityForm.DetailCollection.getAsync = function (index) {
			...
			return new Promise(function (resolve, reject) {
				MobileCRM.UI.EntityForm.DetailCollection.get(index, resolve, function (err) {
					reject(new Error(err));
				});
			});
		};
		...
		MobileCRM.UI.EntityForm.DetailCollection.addProductWithQuantity = function (product, quantity, callback, errorCallback, scope) {
			...
			MobileCRM.bridge.command(
				"addSalesDetailProduct",
				"#" + quantity + ":" + JSON.stringify(product),
				function (detailEntity) {
					detailEntity.update = MobileCRM.UI.EntityForm.DetailCollection._updateDetail;
					if (typeof callback == "function") {
						callback.call(scope, detailEntity);
		...
		MobileCRM.UI.EntityForm.DetailCollection.addAsync = function (product, quantity) {
			...
			return new Promise(function (resolve, reject) {
				MobileCRM.UI.EntityForm.DetailCollection.addProductWithQuantity(product, quantity, resolve, function (err) {
					reject(new Error(err));
				});
			});
		};
		...
		MobileCRM.Services.ChatService.prototype.postMessage = function (regardingEntity, text, callback, errorCallback, scope) {
			...
			MobileCRM.bridge.command(
				...
				JSON.stringify({
					method: "postMessage",
					entityName: regardingEntity.entityName,
					entityId: regardingEntity.id,
					primaryName: regardingEntity.primaryName,
					text: text,
				}),
				callback,
				errorCallback,
		...
		MobileCRM.Services.ChatService.prototype.attachNoteToPost = function (postId, filePath, mimeType, subject, callback, errorCallback, scope) {
			...
			MobileCRM.bridge.command(
				"chatService",
				JSON.stringify({ method: "attachNoteToPost", postId: postId, filePath: filePath, mimeType: mimeType, subject: subject }),
				callback,
				errorCallback,
				scope
			);
		...
		MobileCRM.Services.CompanyInformation.getCompanyInfoFromVat = function (vat, callback, errorCallback, scope) {
			...
			var content =
				"<SOAP-ENV:Envelope xmlns:ns1='urn:ec.europa.eu:taxud:vies:services:checkVat:types' xmlns:SOAP-ENV='http://schemas.xmlsoap.org/soap/envelope/'>" +
		...
		MobileCRM.Services.GeoAddress.prototype.toLocation = function (success, failed, scope) {
			...
			/// <param name="failed" type="function(errorMsg)">A callback which is called in case of error.</param>
			/// <param name="scope" type="Object">The scope for callbacks.</param>
			MobileCRM.bridge.command("addressToLocation", JSON.stringify(this), success, failed, scope);
		};
		//// --- AIVISION ---
		MobileCRM.Services.AIVision.create = function (settings) {
			...
			aivison._settings = [];
			aivison._settings.push(
				'{ "name":"' +
					settings.modelName +
					'", "predictionKey":"' +
					settings.predictionKey +
					'", "url":"' +
					settings.url +
					'", "serviceType":"' +
		...
		if (typeof window != "undefined") {
			if (document.location.search.indexOf("wc_mcrm_bid|") >= 0) {
				// when running on webclient, that client appends 'wc_mcrm_bid|' is part of the 'data' attribute
				var getWCBridgeInstanceId = function () {
				...
				var parseMessageObject = function (obj) {
					if (Array.isArray(obj)) {
						return obj.map(parseMessageObject);
					}
					if (obj && typeof obj === "object") {
						if ("args" in obj) {
							var getGlobalFunction = function (fullName) {
								var type = fullName.split(".");
								var globalFn = window;
								for (var frag of type) {
									if (frag in globalFn) {
										globalFn = globalFn[frag];
									} else {
										globalFn = undefined;
										break;
									}
								...
								if (typeof globalFn === "function") {
									...
									throw new Error(`Unexpected global function "${type}"`);
								}
							};
							var globalFn, args;
							if ("$JSExecute" in obj) {
								globalFn = getGlobalFunction(obj["$JSExecute"]);
								args = parseMessageObject(obj.args);
								if ("catchErrorPrefix" in obj) {
									try {
										return globalFn.apply(window, args);
									} catch (error) {
										return obj["catchErrorPrefix"] + error;
									}
								} else {
									return globalFn.apply(window, args);
								}
							}
							if ("$JSCreateInstance" in obj) {
								var typeName = obj["$JSCreateInstance"];
								if (typeName == "Date") {
									return new Date(obj.args[0]);
								}
								globalFn = getGlobalFunction(typeName);
								args = parseMessageObject(obj.args);
								var instance = Object.create(globalFn.prototype);
								globalFn.apply(instance, args);
								return instance;
							}
						}
						var result = {};
						for (const subNode in obj) {
							result[subNode] = parseMessageObject(obj[subNode]);
						}
						return result;
					}
					return obj;
				};
				var receiveMessageFromWebClient = function (event) {
					...
					try {
						if (data && data.indexOf("json") === 0) {
							...
							if (index >= 0) {
								...
								var result = parseMessageObject(JSON.parse(evalCode));
								if (evalId) {
					...
					if ("notify" in external || win10) {
						...
						if (!("alert" in window)) {
							window.alert = function (text) {
								MobileCRM.bridge.command("alert", text);
							};
						}
						MobileCRM.Bridge.prototype.alert = function (text, callback, scope) {
							MobileCRM.bridge.command("alert", text, callback, callback, scope);
